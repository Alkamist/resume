    ...
    <>
      ...
      <div className="bg-zinc-800 p-8">
        <p className="max-w-[36rem] mx-auto font-light">
          ...
          in show and movie scores. The EP can be found on YouTube <TextLink href="https://www.youtube.com/watch?v=rGfL9Cex-VM&list=PL1OXSs0OIdMY9KI69yeYktn5oDvnauC_Q">here</TextLink>.
        </p>
      </div>
    </>
  )
