    ...
    <>
      ...
      <div className="bg-zinc-800 p-8">
        <p className="max-w-[36rem] mx-auto font-light">
          ...
          an interactive ride/game where guests stand on a conveyor belt and are brought through a series of rooms. The guests are provided
          with blasters which they can fire at the various entities that appear on the screens in each room.<br/><br/>

          I was contracted by VisibleSound to compose the music for the queue lines, as well as the ride itself. The sound effects were handled
          by the game development team hired by Universal.
        </p>
      </div>
    </>
  )
