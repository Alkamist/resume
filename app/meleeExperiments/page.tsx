    ...
    <>
      ...
      <div className="bg-zinc-800 p-8">
        <p className="max-w-[36rem] mx-auto font-light">
          ...
          It is the second installment in the series, yet to this day maintains an active community.
          ...
          I sought to alleviate this by creating my own arcade-like controller from scratch.
          I originally did this using an Arduino with Sanwa arcade buttons as input.
          Eventually though, I decided to just utilize my computer keyboard by writing a Windows program that intercepts
          keyboard input, translates it to GameCube controller input, and then passes it to the Dolphin Emulator.
          ...
          Another experiment I did with Super Smash Bros. Melee was to try to create a custom bot to fight against using machine learning.
          ...
          it as input for an AI. There was a fairly successful effort to make an AI this way at the time, and I decided to try my hand.
          Although I was never able to create anything formidable, I was able to manage to get an AI to move around and spam attacks
