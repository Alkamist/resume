...
function TopInfo() {
  return (
    <div className="flex flex-row justify-between items-center p-4 w-full gap-8 max-w-[1000px] mx-auto overflow-hidden">
      <div>
...
function ProjectCard({ children, href, src, alt }: any) {
  return (
    <Link href={href}>
      <motion.div className="w-[24rem] bg-zinc-800 rounded" whileHover={{ scale: 1.05 }}>
