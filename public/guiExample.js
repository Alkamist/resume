...
var wasmBinaryFile;
  wasmBinaryFile = 'guiExample.wasm';
...
var ASM_CONSTS = {
  546360: ($0) => { document.body.style.cursor = UTF8ToString($0) },
 546406: () => { return window.innerWidth; },
 546436: () => { return window.innerHeight; },
 546467: () => { return window.devicePixelRatio }
};
...
var _onMousePress = Module['_onMousePress'] = createExportWrapper('onMousePress');
var _onMouseRelease = Module['_onMouseRelease'] = createExportWrapper('onMouseRelease');
